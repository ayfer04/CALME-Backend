...
from app.api.v1 import assess, cabine, dialogue, health, ingest, medecin, recommendations, sessions, stream, tts
...
app.include_router(medecin.router, prefix="/api/v1", tags=["medecin"])
